...
public class GetCelestialBodyRequest {

    private String username;
    private String celestialBodyId;

    public GetCelestialBodyRequest() {

    }

    public GetCelestialBodyRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        GetCelestialBodyRequest that = (GetCelestialBodyRequest) o;
    ...
    public static final class Builder {
        ...
        public GetCelestialBodyRequest build() {
            return new GetCelestialBodyRequest(this);
        }
    }
}
