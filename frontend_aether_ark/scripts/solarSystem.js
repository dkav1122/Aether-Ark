...
window.onload = async function (evt) {
    ...
    const url = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}`;
    axios.get(url, {
        params: {
            email: email
        }
        ...
        .then((res) => {
            ...
            const systemUrl = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}/solarSystem/${firstSolarSystemId}`;
...
const createSolar = async (evt) => {
    ...
    const url = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}/solarSystem/`
