...
const login = async (evt) => {
  ...
  const url = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/login/`
...
const post = async (evt) => {
  ...
  const url = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user`
  populateRequest(username);
  populateRequest(email);
