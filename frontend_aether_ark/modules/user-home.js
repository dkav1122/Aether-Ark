...
window.onload = (evt) => {
  ...
  const userUrl = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}`
...
function getSolarSystem(solarSystemId) {
  ...
  const solarUrl = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}/solarSystem/${solarSystemId}`
  axios.get(solarUrl)
    .then((res) => {
      console.log("response", res.data);
      return res.data;
...
function getCelestialBody(celestialBodyId) {
  ...
  const bodyUrl = `https://gihcso6k70.execute-api.us-west-2.amazonaws.com/Project/user/${username}/celestialBody/${celestialBodyId}`
